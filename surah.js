...
(function () {
  ...
  const API_URL =
    ...
    '/editions/' + ARABIC_EDITION + ',' + TRANSLATION_EDITION + ',' + reciter;
      ...
      return (
        '<li class="ayah-item" data-index="' + i + '" data-ayah="' + a.numberInSurah + '">' +
          '<div class="ayah-arabic-row">' +
            '<p class="ayah-arabic" lang="ar" dir="rtl">' + a.arabicText + ' ' +
  ...
  function loadSurah() {
    ...
    fetch(API_URL)
      ...
      .then(function (json) {
        ...
        const translationData = editions[1];
        const audioData = editions[2];
